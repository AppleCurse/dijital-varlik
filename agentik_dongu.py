...
def gorev_tipini_belirle(gorev: str) -> GorevTipi:
    ...
    ⚡ Bolt Optimization: Prefer iterating through globally scoped immutable tuples using C-level 'in' checks over locally allocated lists to avoid object recreation overhead.
    """
    g = gorev.lower()
